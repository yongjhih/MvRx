...
# around. Additionally, a static create and init method will be generated in the case a companion object factory
# is used with JvmStatic. This is accessed via reflection.
-keepclassmembers class ** extends com.airbnb.mvrx.BaseMvRxViewModel {
    public <init>(...);
