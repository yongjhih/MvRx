...
abstract class BaseMvRxViewModel<S : MvRxState>(
    ...
    protected fun subscribe(subscriber: (S) -> Unit) =
        stateStore.observable.subscribeLifecycle(null, null, false, subscriber)

    @RestrictTo(RestrictTo.Scope.LIBRARY)
    fun subscribe(owner: LifecycleOwner, viewId: String?, uniqueOnly: Boolean = false, subscriber: (S) -> Unit) =
        stateStore.observable.subscribeLifecycle(owner, viewId, uniqueOnly, subscriber)
    ...
    protected fun <A> selectSubscribe(
        ...
        subscriber: (A) -> Unit
    ) = selectSubscribeInternal(null, prop1, null, false, subscriber)
    ...
    fun <A> selectSubscribe(
        ...
        subscriber: (A) -> Unit
    ) = selectSubscribeInternal(owner, prop1, viewId, uniqueOnly, subscriber)
    ...
    private fun <A> selectSubscribeInternal(
        ...
        .subscribeLifecycle(owner, viewId, uniqueOnly) { (a) -> subscriber(a) }
    ...
    ) = asyncSubscribeInternal(null, asyncProp, null,false, onFail, onSuccess)
    ...
    fun <T> asyncSubscribe(
        ...
        onFail: ((Throwable) -> Unit)? = null,
        onSuccess: ((T) -> Unit)? = null
    ) = asyncSubscribeInternal(owner, asyncProp, viewId, uniqueOnly, onFail, onSuccess)
    ...
    private fun <T> asyncSubscribeInternal(
        ...
        onFail: ((Throwable) -> Unit)? = null,
        onSuccess: ((T) -> Unit)? = null
    ) = selectSubscribeInternal(owner, asyncProp, viewId, uniqueOnly) { asyncValue ->
    ...
    protected fun <A, B> selectSubscribe(
        ...
        subscriber: (A, B) -> Unit
    ) = selectSubscribeInternal(null, prop1, prop2, null,false, subscriber)
    ...
    fun <A, B> selectSubscribe(
        ...
        uniqueOnly: Boolean = false,
        subscriber: (A, B) -> Unit
    ) = selectSubscribeInternal(owner, prop1, prop2, viewId, uniqueOnly, subscriber)
    ...
    private fun <A, B> selectSubscribeInternal(
        ...
        .distinctUntilChanged()
        .subscribeLifecycle(owner, viewId, uniqueOnly) { (a, b) -> subscriber(a, b) }
    ...
    ) = selectSubscribeInternal(null, prop1, prop2, prop3, null, false, subscriber)
    ...
    fun <A, B, C> selectSubscribe(
        ...
        uniqueOnly: Boolean = false,
        subscriber: (A, B, C) -> Unit
    ) = selectSubscribeInternal(owner, prop1, prop2, prop3, viewId, uniqueOnly, subscriber)
    ...
    private fun <A, B, C> selectSubscribeInternal(
        ...
        .distinctUntilChanged()
        .subscribeLifecycle(owner, viewId, uniqueOnly) { (a, b, c) -> subscriber(a, b, c) }
    ...
    ) = selectSubscribeInternal(null, prop1, prop2, prop3, prop4, viewId, false, subscriber)
    ...
    fun <A, B, C, D> selectSubscribe(
        ...
        uniqueOnly: Boolean = false,
        subscriber: (A, B, C, D) -> Unit
    ) = selectSubscribeInternal(owner, prop1, prop2, prop3, prop4, viewId, uniqueOnly, subscriber)
    ...
    private fun <A, B, C, D> selectSubscribeInternal(
        ...
        .distinctUntilChanged()
        .subscribeLifecycle(owner, viewId, uniqueOnly) { (a, b, c, d) -> subscriber(a, b, c, d) }
    ...
    ) = selectSubscribeInternal(null, prop1, prop2, prop3, prop4, prop5, null, false, subscriber)
    ...
    fun <A, B, C, D, E> selectSubscribe(
        ...
        uniqueOnly: Boolean = false,
        subscriber: (A, B, C, D, E) -> Unit
    ) = selectSubscribeInternal(owner, prop1, prop2, prop3, prop4, prop5, viewId, uniqueOnly, subscriber)
    ...
    private fun <A, B, C, D, E> selectSubscribeInternal(
        ...
        .distinctUntilChanged()
        .subscribeLifecycle(owner, viewId, uniqueOnly) { (a, b, c, d, e) -> subscriber(a, b, c, d, e) }
    ...
    ) = selectSubscribeInternal(null, prop1, prop2, prop3, prop4, prop5, prop6, null,false, subscriber)
    ...
    fun <A, B, C, D, E, F> selectSubscribe(
        ...
        uniqueOnly: Boolean = false,
        subscriber: (A, B, C, D, E, F) -> Unit
    ) = selectSubscribeInternal(owner, prop1, prop2, prop3, prop4, prop5, prop6, viewId, uniqueOnly, subscriber)
    ...
    private fun <A, B, C, D, E, F> selectSubscribeInternal(
        ...
        .distinctUntilChanged()
        .subscribeLifecycle(owner, viewId, uniqueOnly) { (a, b, c, d, e, f) -> subscriber(a, b, c, d, e, f) }
    ...
    ) = selectSubscribeInternal(null, prop1, prop2, prop3, prop4, prop5, prop6, prop7, null, false, subscriber)
    ...
    fun <A, B, C, D, E, F, G> selectSubscribe(
        ...
        uniqueOnly: Boolean = false,
        subscriber: (A, B, C, D, E, F, G) -> Unit
    ) = selectSubscribeInternal(owner, prop1, prop2, prop3, prop4, prop5, prop6, prop7,  viewId, uniqueOnly, subscriber)
    ...
    private fun <A, B, C, D, E, F, G> selectSubscribeInternal(
        ...
        .distinctUntilChanged()
        .subscribeLifecycle(owner, viewId, uniqueOnly) { (a, b, c, d, e, f, g) -> subscriber(a, b, c, d, e, f, g) }
    ...
    private fun <T : Any> Observable<T>.subscribeLifecycle(
        ...
        val lifecycleAwareObserver = MvRxLifecycleAwareObserver(
            ...
            viewId?.let {
                @Suppress("UNCHECKED_CAST")
                lastDeliveredStates[it] as? T
            },
            { value: T -> viewId?.let { lastDeliveredStates[it] = value } },
            alwaysDeliverLastValueWhenUnlocked = !uniqueOnly,
            onNext = Consumer { subscriber(it) }
        )
        return observeOn(AndroidSchedulers.mainThread())
